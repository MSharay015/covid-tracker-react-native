...
type Props = {
  navigation: StackNavigationProp<ScreenParamList, 'VaccineTrial'>;
  route: RouteProp<ScreenParamList, 'VaccineTrial'>;
};

export const VaccineTrialScreen: React.FC<Props> = ({ route, navigation }) => {
